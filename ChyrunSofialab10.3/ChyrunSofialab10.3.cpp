// ChyrunSofialab10.3.cpp : This file contains the 'main' function. Program execution begins and ends there.
// Lab_10_3.cpp
// < Чирун Софія >
...
void Print(char* fname, Price* p, const int N);
...
void CreateTXT(char* fname, Price* p, const int N) 
{
	ofstream fout(fname); 
	string s; 
	cout << endl;
	fout << "===================================================="
		<< endl;
	fout << "| № | Товар | Магазин |   Тип товару   |   Ціна    |"
		<< endl;
	fout << "----------------------------------------------------"
		<< endl;
	for (int i = 0; i < N; i++)
